...
\newcommand{\docVersionAdR}{\emph{v6.0.0}} % Analisi dei Requisiti
\newcommand{\docVersionGlo}{\emph{v4.0.0}} % Glossario
\newcommand{\docVersionNdP}{\emph{v6.0.0}} % Norme di Progetto
\newcommand{\docVersionPdP}{\emph{v7.0.0}} % Piano di Progetto
\newcommand{\docVersionPdQ}{\emph{v6.0.0}} % Piano di Qualifica
\newcommand{\docVersionSdF}{\emph{v2.0.0}} % Studio di Fattibilità
\newcommand{\docVersionST}{\emph{v3.0.0}} % Specifica Tecnica
\newcommand{\docVersionDdP}{\emph{v4.0.0}} % Definizione di Prodotto
\newcommand{\docVersionMU}{\emph{v3.0.0}} % Manuale Utente
\newcommand{\docVersionMA}{\emph{v3.0.0}} % Manuale Amministratore
% ==================================================================================================
